...
#define AXP_GPIO0_CFG                   (POWER20_GPIO0_CTL)//0x90
#define AXP_GPIO1_CFG                   (POWER20_GPIO1_CTL)//0x92
#define AXP_GPIO2_CFG                   (POWER20_GPIO2_CTL)//0x93
#define AXP_GPIO01_STATE                (POWER20_GPIO012_SIGNAL)//0x94
#define AXP_GPIO3_CFG                   (POWER20_GPIO3_CTL)//0x95
#endif
/*    AXP15
