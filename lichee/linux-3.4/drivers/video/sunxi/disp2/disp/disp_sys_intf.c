...
int disp_sys_register_irq(u32 IrqNo, u32 Flags, void* Handler,void *pArg,u32 DataSize,u32 Prio)
{
	...
	return request_irq(IrqNo, (irq_handler_t)Handler, IRQF_DISABLED, "display", pArg);
}
...
EXPORT_SYMBOL(disp_sys_gpio_set_direction);
...
EXPORT_SYMBOL(disp_sys_gpio_get_value);
...
EXPORT_SYMBOL(disp_sys_gpio_set_value);
