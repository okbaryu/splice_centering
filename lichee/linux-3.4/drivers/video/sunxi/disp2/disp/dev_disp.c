...
int lcd_reinit = 1;
module_param_named(lcd_reinit, lcd_reinit, int, 0644);
...
static s32 parser_disp_init_para(disp_init_para * init_para)
{
	...
	__inf("[INFO] set init_para->b_init = %d \n", value);
...
static s32 disp_init(struct platform_device *pdev)
{
	...
	__inf("before fb_init ::g_disp_drv.disp_init.b_init = %d\n", g_disp_drv.disp_init.b_init);
	fb_init(pdev);
