 ...
 *
 * Version		   Modify              Date		     Email                       Description			  
 *   1.0		   richard.liu       2015/11/24      liubaihao@sina.com.cn       set reg NSA_REG_INT_PIN_CONFIG low level
 *************************************************************************************************************************
 */
...
#if defined(CONFIG_DA280_INTERRUPT_LOW_LEVEL)
