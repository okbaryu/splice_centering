...
#define KEY_MODE_SELECT         (3 << 12)
#define KEY_MODE_NORMAL         (0)

#define FIRST_CONVERT_DLY       (0xFF << 24)
#define FIRST_CONVERT_DLY_1     (1 << 24)

#define LEVELB_VOL              (0<<4)
#define LRADC_HOLD_EN           (1<<6)

#define LRADC_SAMPLE_RATE       (3<<2)
...
enum int_mode {
	...
	ADC1_DOWN_INT_SET = (1<<3),
	ADC1_UP_INT_SET = (1<<4),
	ADC1_DATA_INT_SET = (1<<5),
};
#endif
