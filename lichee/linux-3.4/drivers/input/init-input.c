 ...
 *
 */
int input_request_int(enum input_sensor_type *input_type, irq_handler_t handler,
			unsigned long trig_type, void *para)
{
	return input_request_irq(input_type, handler, NULL, trig_type, para);
}
EXPORT_SYMBOL(input_request_int);

int input_request_irq(enum input_sensor_type *input_type,
...
EXPORT_SYMBOL(input_request_irq);
