...
#define VL53L0_TOF_CONFIG	"vl53l0_tof_para"
static int vl53l0_reg_on = 0;
static int vl53l0_shdn = 1;
static int vl53l0_int = 2; //TBD.....#define USE_INT .. IRQ_NUM....

#define HT_GPIO_NUM 3
static char *ctl_gpio_name[] = {"vl53l0_reg_on", "vl53l0_shdn", "vl53l0_int"};
static gpio_set_t ht_ithink_gpio[HT_GPIO_NUM];
static unsigned int ht_gpio[HT_GPIO_NUM];

static void __init sysconfig_init(void)
{
	int i;
    for (i = 0; i < HT_GPIO_NUM; i++)
    {
        vl53l0_sys_script_get_item(VL53L0_TOF_CONFIG, ctl_gpio_name[i], (int *)&ht_ithink_gpio[i], sizeof(gpio_set_t)/sizeof(__u32));
        ht_gpio[i] = vl53l0_sys_gpio_request(&ht_ithink_gpio[i], 1);
    }
}
...
static int __init stmvl53l0_init(void)
{
    ...
    vl53l0_gpio_write_one_pin_value(ht_gpio[vl53l0_reg_on], 1, NULL);
    mdelay(100);
    vl53l0_gpio_write_one_pin_value(ht_gpio[vl53l0_shdn], 1, NULL);
    mdelay(100);
...
static void __exit stmvl53l0_exit(void)
{
    ...
    gpio_direction_output(vl53l0_shdn, 1);
    mdelay(10);
    gpio_direction_output(vl53l0_reg_on, 1);
    mdelay(10);
    gpio_free(vl53l0_shdn);
    gpio_free(vl53l0_reg_on);
