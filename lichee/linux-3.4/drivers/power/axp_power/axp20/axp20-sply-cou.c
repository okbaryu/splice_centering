...
static inline int axp20_vts_to_temp(int data)
{
	int temp;
	if (data < 80)
		return 30;
	else if (data < axp20_config.pmu_temp_para16)
		return 80;
	else if (data <= axp20_config.pmu_temp_para15) {
		temp = 70 + (axp20_config.pmu_temp_para15-data)*10/(axp20_config.pmu_temp_para15-axp20_config.pmu_temp_para16);
	} else if (data <= axp20_config.pmu_temp_para14) {
		temp = 60 + (axp20_config.pmu_temp_para14-data)*10/(axp20_config.pmu_temp_para14-axp20_config.pmu_temp_para15);
	} else if (data <= axp20_config.pmu_temp_para13) {
		temp = 55 + (axp20_config.pmu_temp_para13-data)*5/(axp20_config.pmu_temp_para13-axp20_config.pmu_temp_para14);
	} else if (data <= axp20_config.pmu_temp_para12) {
		temp = 50 + (axp20_config.pmu_temp_para12-data)*5/(axp20_config.pmu_temp_para12-axp20_config.pmu_temp_para13);
	} else if (data <= axp20_config.pmu_temp_para11) {
		temp = 45 + (axp20_config.pmu_temp_para11-data)*5/(axp20_config.pmu_temp_para11-axp20_config.pmu_temp_para12);
	} else if (data <= axp20_config.pmu_temp_para10) {
		temp = 40 + (axp20_config.pmu_temp_para10-data)*5/(axp20_config.pmu_temp_para10-axp20_config.pmu_temp_para11);
	} else if (data <= axp20_config.pmu_temp_para9) {
		temp = 30 + (axp20_config.pmu_temp_para9-data)*10/(axp20_config.pmu_temp_para9-axp20_config.pmu_temp_para10);
	} else if (data <= axp20_config.pmu_temp_para8) {
		temp = 20 + (axp20_config.pmu_temp_para8-data)*10/(axp20_config.pmu_temp_para8-axp20_config.pmu_temp_para9);
	} else if (data <= axp20_config.pmu_temp_para7) {
		temp = 10 + (axp20_config.pmu_temp_para7-data)*10/(axp20_config.pmu_temp_para7-axp20_config.pmu_temp_para8);
	} else if (data <= axp20_config.pmu_temp_para6) {
		temp = 5 + (axp20_config.pmu_temp_para6-data)*5/(axp20_config.pmu_temp_para6-axp20_config.pmu_temp_para7);
	} else if (data <= axp20_config.pmu_temp_para5) {
		temp = 0 + (axp20_config.pmu_temp_para5-data)*5/(axp20_config.pmu_temp_para5-axp20_config.pmu_temp_para6);
	} else if (data <= axp20_config.pmu_temp_para4) {
		temp = -5 + (axp20_config.pmu_temp_para4-data)*5/(axp20_config.pmu_temp_para4-axp20_config.pmu_temp_para5);
	} else if (data <= axp20_config.pmu_temp_para3) {
		temp = -10 + (axp20_config.pmu_temp_para3-data)*5/(axp20_config.pmu_temp_para3-axp20_config.pmu_temp_para4);
	} else if (data <= axp20_config.pmu_temp_para2) {
		temp = -15 + (axp20_config.pmu_temp_para2-data)*5/(axp20_config.pmu_temp_para2-axp20_config.pmu_temp_para3);
	} else if (data <= axp20_config.pmu_temp_para1) {
		temp = -25 + (axp20_config.pmu_temp_para1-data)*10/(axp20_config.pmu_temp_para1-axp20_config.pmu_temp_para2);
	} else
		temp = -25;
    return temp;
}

static int axp20_bat_temp_set(int bat_temp)
{
	static int count = 0;
...
static inline int axp20_vts_to_mV(uint16_t reg)
{
  ...
  struct axp_adc_res *adc)
{
  ...
  adc->idischar_res = ((uint16_t) tmp[4] << 8 )| tmp[5];
	axp_reads(charger->master,AXP20_TSH_RES,2,tmp);
	adc->ts_res = ((uint16_t) tmp[0] << 8 )|(tmp[1] & 0xf);
}
...
static void axp_charger_update(struct axp_charger *charger)
{
  ...
  if(!charger->ext_valid){
	...
	bat_temp_mv = axp20_vts_to_mV(tmp);
	bat_temp = axp20_vts_to_temp(bat_temp_mv);
	charger->bat_temp = axp20_bat_temp_set(bat_temp);
}
...
static int axp_battery_adc_set(struct axp_charger *charger)
{
  ...
  | AXP20_ADC_USBVOL_ENABLE | AXP20_ADC_USBCUR_ENABLE;
	...
	if (0 != axp20_config.pmu_temp_enable)
...
static int axp_battery_probe(struct platform_device *pdev)
{
  ...
  /* initial restvol*/
	...
	if (0 != axp20_config.pmu_temp_enable) {
		axp_write(charger->master,0x38,axp20_config.pmu_charge_ltf*10/128);
		axp_write(charger->master,0x39,axp20_config.pmu_charge_htf*10/128);
		axp_write(charger->master,0x3C,axp20_config.pmu_discharge_ltf*10/128);
		axp_write(charger->master,0x3D,axp20_config.pmu_discharge_htf*10/128);
	}
