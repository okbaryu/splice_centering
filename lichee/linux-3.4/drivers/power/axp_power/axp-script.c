...
int axp20_fetch_sysconfig_para(char * pmu_type, struct axp20_config_info *axp_config)
{
	...
	if (axp_config->pmu_used) {
		...
		if (ret)
		{
			// printk("axp: using default value(0) for pmu_chgled_func @ %d\n", __LINE__);
			axp_config->pmu_chgled_func = 0;
		}
		ret = axp_script_parser_fetch(pmu_type, "pmu_chgled_type", &axp_config->pmu_chgled_type, sizeof(int));
		if (ret)
		{
			// printk("axp: using default value(0) for pmu_chgled_type @ %d\n", __LINE__);
			axp_config->pmu_chgled_type = 0;
		}
		...
		if (ret)
		{
			printk("axp: using default value(6000) for pmu_pekoff_time @ %d\n", __LINE__);
			axp_config->pmu_pekoff_time = 6000;
		}
		ret = axp_script_parser_fetch(pmu_type, "pmu_pekoff_en", &axp_config->pmu_pekoff_en, sizeof(int));
		if (ret)
		...
		if (ret)
		{
			// printk("axp: using default value(0) for pmu_temp_enable @ %d\n", __LINE__);
			axp_config->pmu_temp_enable = 0;
		}
		...
		if (ret)
		{
			// printk("axp: using default value(0xA5) for pmu_charge_ltf @ %d\n", __LINE__);
			axp_config->pmu_charge_ltf = 0xA5;
		}
		...
		if (ret)
		{
			// printk("axp: using default value(0x1F) for pmu_charge_htf @ %d\n", __LINE__);
			axp_config->pmu_charge_htf = 0x1F;
		}
		...
		if (ret)
		{	
			// printk("axp: using default value(0xFC) for pmu_discharge_ltf @ %d\n", __LINE__);
			axp_config->pmu_discharge_ltf = 0xFC;
		}
		...
		if (ret)
		{	
			// printk("axp: using default value(0x16) for pmu_discharge_htf @ %d\n", __LINE__);
			axp_config->pmu_discharge_htf = 0x16;
		}
		...
		if (ret)
		{
			// printk("axp: using default value(0) for pmu_battery_warning1 @ %d\n", __LINE__);
		...
		if (ret)
		{
			// printk("axp: using default value(0) for pmu_battery_warning2 @ %d\n", __LINE__);
		...
		if (ret)
		{
			// printk("axp: using default value(120) for pmu_chg_stop_temp @ %d\n", __LINE__);
		...
		if (ret)
		{
			// printk("axp: using default value(110) for pmu_chg_restart_temp @ %d\n", __LINE__);
