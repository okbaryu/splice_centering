...
ifeq ($(BR2_TOOLCHAIN_EXTERNAL_LINARO_ARM2017Q1HF),y)
TOOLCHAIN_EXTERNAL_SITE=https://releases.linaro.org/components/toolchain/binaries/4.9-2017.01/arm-linux-gnueabihf
TOOLCHAIN_EXTERNAL_SOURCE=gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf.tar.xz
else ifeq ($(BR2_TOOLCHAIN_EXTERNAL_CODESOURCERY_ARM2009Q1),y)
