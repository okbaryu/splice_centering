...
define OPENSSL_UNINSTALL_CMDS
	...
	rm -rf $(addprefix $(TARGET_DIR)/usr/lib/,ssl engines-1.1 libcrypto* libssl* pkgconfig/libcrypto.pc)
	rm -rf $(addprefix $(STAGING_DIR)/,etc/ssl usr/bin/openssl usr/include/openssl)
	rm -rf $(addprefix $(STAGING_DIR)/usr/lib/,ssl engines-1.1 libcrypto* libssl* pkgconfig/libcrypto.pc)
endef
