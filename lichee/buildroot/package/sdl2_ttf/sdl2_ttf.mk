...
SDL2_TTF_DEPENDENCIES = sdl2 freetype host-pkg-config

# Two patches touching configure.in
SDL2_TTF_AUTORECONF = YES

SDL2_TTF_CONF_ENV = \
	FREETYPE_CONFIG="$(STAGING_DIR)/usr/bin/freetype-config --prefix=$(STAGING_DIR)/usr"
...
$(eval $(call AUTOTARGETS,package,sdl2_ttf))
