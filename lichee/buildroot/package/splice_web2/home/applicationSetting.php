      ...
      <div class="container">
        <div class="container1">
          <ul>
            <li>
              <a href="#">
                <div class="inContainer" onclick="location.href='./applicationSetting/systemSetting.php'">
            ...
            <li>
              <a href="#">
                <div class="inContainer1" onclick="location.href='./applicationSetting/plcSetting.php'">
