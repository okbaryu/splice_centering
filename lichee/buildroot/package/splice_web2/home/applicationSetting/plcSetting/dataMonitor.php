<?php
 ...
 <html>
   ...
   <body>
     <div class="container">
       <span style="position:absolute;top: 100px;left: 120px;">PLC => Controller</span>
       <span style="position:absolute;top: 100px;left: 460px;">Controller => PLC</span>
       <div class="dataTable" style="position: absolute; top:180px; left:25px;">
           <ul class="label1 labelU" style="position:relative; left:4px; top:4px;">
           ...
           <ul class="tableLabel1" style="position:absolute; top:30px;left:80px;">
             ...
             <li class="tableLi">high</li>
             <li class="tableLi">bin</li>
             <li class="tableLi">low</li>
           </ul>
           <ul class="tableLabel1" style="position:absolute; top:30px;left:440px;">
             <li class="tableLi">hex</li>
             <li class="tableLi">dec</li>
             <li class="tableLi">high</li>
             <li class="tableLi">bin</li>
             <li class="tableLi">low</li>
