...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/home/applicationSetting/systemSetting/belt/centeringParam/autoSplice.css">
  </head>
  <body>
    <div class="container"><br>
      <img src="../../../../../images/web_GUI/web_GUI/09_background img.jpg" width="710px" height="540px" style="position:relative; top: -30px;">
      <div class="box">
        ...
        <ul style="position:relative; top: 195px; left: -25px;">
          <li class="label">Splice Offset</li>
          <li><input class="value_box" id="TBD" type="text" name="" value="" disabled></li>
        </ul>
      </div>
    </div>
