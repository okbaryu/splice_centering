...
function changePage(tag){
  switch (tag) {
    ...
    carcassButton.style.backgroundColor = '#45464d';
    container.innerHTML = '<iframe src="./syssetting/null.html" frameborder="0" scrolling="no" width="730" height="600"></iframe>';
      break;
    case 'carcassButton':
    beltButton.style.backgroundColor = '#45464d';
    threadButton.style.backgroundColor = '#45464d';
    ...
    case 'plcConnectSet':
      ...
      container.innerHTML = '<iframe src="./syssetting/null1.html" frameborder="0" scrolling="no" width="745" height="584"></iframe>';
      break;
    case 'protocolSet':
