...
#include "gd9161_ips.h"

#define gd9161_ips_spi_scl_1	sunxi_lcd_gpio_set_value(0,2,1)
#define gd9161_ips_spi_scl_0	sunxi_lcd_gpio_set_value(0,2,0)
#define gd9161_ips_spi_sdi_1	sunxi_lcd_gpio_set_value(0,1,1)
#define gd9161_ips_spi_sdi_0	sunxi_lcd_gpio_set_value(0,1,0)

#define gd9161_ips_spi_cs_1  	sunxi_lcd_gpio_set_value(0,0,1)
#define gd9161_ips_spi_cs_0  	sunxi_lcd_gpio_set_value(0,0,0)
...
static s32 LCD_close_flow(u32 sel)
{
	...
	LCD_CLOSE_FUNC(sel, LCD_power_off, 4000);   //close lcd power, and delay 500ms
...
static void write_spidat(u32 value)
{
	u32 i;
	gd9161_ips_spi_cs_0;
	gd9161_ips_spi_sdi_1;
	gd9161_ips_spi_scl_0;
	sunxi_lcd_delay_us(10);
	gd9161_ips_spi_scl_1;
	sunxi_lcd_delay_us(10);
	for(i=0;i<8;i++)
	{
		sunxi_lcd_delay_us(10);
...
//Frame rate: 60HZ  
//VCI=2.8V, IOVCC=1.8V 
	write_spicom(0x01);	sunxi_lcd_delay_ms(200);	// Software reset
	...
	write_spicom(0x36); // SETGIP2 
	write_spidat(0x03); // direction 00-03
...
__lcd_panel_t  gd9161_ips_panel = {
