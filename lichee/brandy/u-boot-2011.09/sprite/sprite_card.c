...
#else
#define  SPRITE_CARD_ONCE_DATA_DEAL    (1 * 1024 * 1024)
#endif
...
int sunxi_sprite_deal_boot0(int production_media)
{
	...
	else if(production_media == 5)
	{
		imgitemhd = Img_OpenItem(imghd, "12345678", "1234567SPINAND_0");
	}
	else
	{
...
************************************************************************************************************
*/
int sunxi_sprite_deal_part_from_sysrecovery(sunxi_download_info *dl_map)
{
    dl_one_part_info  	*part_info;
	int 				ret  = -1;
	int 				ret1;
