...
extern int write_usb_recovery_to_misc(void);
#endif
...
# endif /* CONFIG_SYS_FLASH_CHECKSUM */
...
#ifndef CONFIG_SUNXI_SPINOR_PLATFORM
	recover = check_boot_recovery_key();
#endif
	...
	if ((workmode == WORK_MODE_CARD_PRODUCT) || (workmode == WORK_MODE_SPRITE_RECOVERY) || recover == 2)
	{
...
//#endif/*CONFIG_GENERIC_MMC*/
	...
	if (workmode == WORK_MODE_BOOT)
	{
		...
		if (!ret)
		{
			...
			if (!gd->chargemode)
			{
#ifndef CONFIG_READ_LOGO_FOR_KERNEL
