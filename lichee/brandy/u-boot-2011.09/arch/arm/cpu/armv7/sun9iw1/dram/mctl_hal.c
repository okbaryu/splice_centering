...
#define RSB_TRANS_ERR_ID1	(0xFF<<16)//8’b00000001 – no ack
...
//	mctl_write_w(MC_CCR, reg_val);
	...
	{
		//********************************************
		//bit21:bit18=0001:pll 摆幅0.4
		//bit21:bit18=0010:pll 摆幅0.3
		//bit21:bit18=0100:pll 摆幅0.2
		//bit21:bit18=1000:pll 摆幅0.1
		//**********************************************
...
unsigned int mctl_sys_init_no_ccu(__dram_para_t *para)
{
	unsigned int reg_val = 0;
...
unsigned int mctl_channel_init(unsigned int ch_index,__dram_para_t *para)
{
	...
	unsigned int tdinit0=0,tdinit1=0,tdinit2=0,tdinit3=0;
	unsigned int dram_freq;
...
signed int init_DRAM(int type, __dram_para_t *para)
{
	...
	uint normal_mode = mctl_read_w(CCM_PLL6_DDR_REG);
    ...
    //DDR3 1.5V else LPDDR2/3 DRAM_VCC=1.2V
	...
	if(!normal_mode)	//secure使能下的none-secure模式
	{
		mctl_sys_init_no_ccu(para);
	}
	else				//normal模式或者secure使能下的secure模式
	{
		mctl_sys_init(para);
	}
